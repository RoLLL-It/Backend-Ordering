...
func Main(args map[string]interface{}) map[string]interface{} {
	...
	orderID, errResp := fn.ParseUUID(args, "id")
	if errResp != nil {
		return errResp
	}
	if err := orderSvc.AdminUpdateStatus(context.Background(), orderID, domain.StatusCancelledAdmin, actorID, "Cancelled by admin"); err != nil {
